...
#Facebook : Basir SaFdari
#Whatsapp : ++93747025516
#Afghanistan Cyber Expert
#Alone Coder 
...
╰━━━┻╯╰┻━━━┻┻╯╰━╯
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94m➣  YouTube  : basir
\x1b[1;94m➣  Facebook : BaSir SaFdati
\x1b[1;94m➣  Note     : Dont ReEdit It 
\x1b[1;94m➣  Github   : https://github.com/basir420
\x1b[1;94m➣  Whatsapp : +93747025516
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;97mAccess Granted "#Dev:basir_420
	    time.sleep(1)
            loop = 'false'
        else:
            print "\033[1;97mACCESS DENIED"
            os.system('xdg-open https://www.facebook.com/Hajiali.MaSTerOfHack')
    else:
        print "\033[1;97mACCESS DENIED"
        os.system('xdg-open https://www.facebook.com/Hajiali.MaSTerOfHack')
def login():
